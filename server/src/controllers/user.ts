...
export const loginUser = TryCatch(async(req, res)=>{//is loginUser controller ko TryCatch में wrap किया ताकि error आए तो automatically catch हो जाए।
    ...
    res.json({//अब frontend को response भेज रहे हो।
